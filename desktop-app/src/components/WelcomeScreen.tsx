  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-black border border-white/10 rounded-xl p-6 shadow-lg">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-medium text-white mb-3">Welcome to LexaAI</h2>
          <p className="text-white/70 text-sm mb-4">
            Your invisible AI-powered coding assistant with multi-provider support
            and advanced screenshot + audio analysis capabilities.
          </p>
          <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Toggle Audio Recording</span>
                <span className="text-white/90">Ctrl+A / Cmd+A</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Process with AI</span>
        ...
        <div className="text-white/40 text-xs text-center">
          Use screenshots (Ctrl+H) or audio (Ctrl+A), then process with Ctrl+Enter
        </div>
      </div>
    </div>
  );
