...
interface ElectronAPI {
  ...
  getAudioRecordings: () => Promise<{ success: boolean; recordings?: any[]; error?: string }>
  deleteAudioRecording: (id: string) => Promise<{ success: boolean; error?: string }>
  clearAudioRecordings: () => Promise<{ success: boolean; error?: string }>
  isRecordingAudio: () => Promise<{ success: boolean; isRecording?: boolean; error?: string }>
  getCurrentAudioRecording: () => Promise<{ success: boolean; recording?: any; error?: string }>
  ...
  onAudioRecordingStarted: (callback: (data: { id: string }) => void) => () => void
  onAudioRecordingStopped: (callback: (recording: any) => void) => () => void
